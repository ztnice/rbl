...
public  class JedisUtil {
     ...
     * @return
     */
    public static String hget(String key, String fiedld) {
        Jedis jedis = getJedis();
    ...
    private static Jedis newJedis() {
        if (pool == null) {
            synchronized (lock){
                if(pool == null){
                    String ip = Properties.getKey("redis.host");
                    int port = Integer.valueOf(Properties.getKey("redis.port"));
                    String password = Properties.getKey("redis.password");
